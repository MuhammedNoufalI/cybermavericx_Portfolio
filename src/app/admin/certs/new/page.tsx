...
export default function NewCertification() {
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <form action={createCertification} className="space-y-6 bg-white dark:bg-gray-800 p-4 sm:p-8 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                <div>
